...
internal sealed class BlazorApplicationFactory<TProgram>(int port) : WebApplicationFactory<TProgram> where TProgram : class
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            ...
            services.AddHttpClient<IShelteredClient, ShelteredClient>(client =>
            {
